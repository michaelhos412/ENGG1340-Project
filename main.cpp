...
int main(){
  ...
  while (true){
    ...
    if (option == 0){
      ...
      if(option == 1){
        SortbyAmount(Records,date,RecordCount,databasesize);
      }
      else if(option == 2){
        ...
        if (type == "i"){
          FilterbyType(Records,date,type,RecordCount,counterline,databasesize);
          FilterbyType(Records,date,"e",RecordCount,counterline,databasesize);
          if (counterline == 0) {
          ...
          FilterbyType(Records,date,type,RecordCount,counterline,databasesize);
          FilterbyType(Records,date,"i",RecordCount,counterline,databasesize);
          if (counterline == 0) {
            cout << "There is no record in the file" << endl;
          }
        }
        ...
        FilterbyAccount(Records , date , "c" ,RecordCount, counterline,databasesize);
        FilterbyAccount(Records , date , "d" ,RecordCount, counterline,databasesize);
        FilterbyAccount(Records , date , "o" ,RecordCount, counterline,databasesize);
        if (counterline == 0) {
          cout << "There is no record in the file" << endl;
        }
      }
        ...
        FilterbyAccount(Records , date , account ,RecordCount, counterline,databasesize);
        if (counterline == 0) {
          cout << "There is no record in the file" << endl;
        }
      }
      else if(option == 6){
        FilterbyCategory(Records , date , "f" ,RecordCount, counterline,databasesize);
        FilterbyCategory(Records , date , "t" ,RecordCount, counterline,databasesize);
        FilterbyCategory(Records , date , "u" ,RecordCount, counterline,databasesize);
        FilterbyCategory(Records , date , "o" ,RecordCount, counterline,databasesize);
        if (counterline == 0) {
          cout << "There is no record in the file" << endl;
        }
      }
        ...
        FilterbyCategory(Records , date , category ,RecordCount, counterline,databasesize);
        if (counterline == 0) {
          cout << "There is no record in the file" << endl;
        }
      }
      ...
      SortbyAmount(Records,DateToEdit,RecordCount,databasesize);
